...
#define LOG_TAG "aoscp.touch@1.0-service.oneplus_sdm845"
...
using ::vendor::aoscp::touch::V1_0::ITouchscreenGesture;
using ::vendor::aoscp::touch::V1_0::implementation::TouchscreenGesture;
